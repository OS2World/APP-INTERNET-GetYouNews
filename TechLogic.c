...
BOOL CheckForMultipart(PSZ pszHeader, ULONG ulHeaderLen, PSZ pszBody, ULONG ulBodyLen, PSZ pszNewsGroup, BOOL bLogs)
{
   ...
   pszUserAgent = SearchFor("X-Poster: Tech Logic",pszHeader, ulHeaderLen, pszUserAgent);
...
/*                     ulDirSize = sizeof(szCurrentDir);
                     ...
                     if (rc == 0)
                     {
                        ...
                        if (ulTotal > 1)
                        {
/*                           printf("Saving Tech Logic %s part %d of %d\r\n ",szFileName, ulPart, ulTotal);  */
                           sprintf(szNewFileName,"%s\\%s.TL%d",pszNewsGroup,szFileName, ulPart);

                        }
                        else
                        {
/*                           printf("Saving Tech Logic %s",szFileName);  */
                        ...
                        if (rc == 0)
                        {
                           ...
                           if (ulTotal > 1)
                           {
                              ...
                              sprintf(szFindFile,"%s\\%s.TL*",pszNewsGroup,szFileName);
...
/*                                 printf("Merging Tech Logic post file %s ", szFileName);  */
                                 fflush(NULL);
                                 ...
                                 if (rc == 0)
                                 {
                                    ...
                                    for (x = 1; x <= ulNumFiles; x++)
                                    {
                                       ...
                                       sprintf(szNewFileName,"%s\\%s.TL%d",pszNewsGroup,szFileName, x);
                        ...
                        if (bLogs)
                           SaveLog("TechLogic.LOG",pszHeader, ulHeaderLen, pszNewsGroup, strcmp(pszNewsGroup, szGroup));
