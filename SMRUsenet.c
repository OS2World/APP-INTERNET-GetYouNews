...
BOOL CheckForMultipart(PSZ pszHeader, ULONG ulHeaderLen, PSZ pszBody, ULONG ulBodyLen, PSZ pszNewsGroup, BOOL bLogs)
{
   ...
   x = _dllentry;
   pszNEWSPoster = SearchFor("X-Newsposter: smr-usenet power-post",pszHeader, ulHeaderLen, pszNEWSPoster);
...
/*                  ulDirSize = sizeof(szCurrentDir);
                  ...
                  if (rc == 0)
                  {
                     ...
                     if (ulTotal > 1)
                     {
                        sprintf(szNewFileName,"%s\\%s.SMR%d",pszNewsGroup,szFileName, ulPart);
/*                        printf("Saving smr-usenet %s, part %d of %d\r\n",szFileName, ulPart,ulTotal);  */
                     }
                     else
                     {

                        sprintf(szNewFileName,"%s\\%s",pszNewsGroup,szFileName, ulPart);
/*                        printf("Saving smr-usenet %s ",szFileName);  */
                     }
                     ...
                     if (rc == 0)
                     {
                        ...
                        if (ulTotal > 1)
                        {
                           ...
                           sprintf(szFindFile,"%s\\%s.SMR*",pszNewsGroup,szFileName);
...
/*                              printf("Merging smr-usenet %s", szFileName); */
                              ...
                              if (rc == 0)
                              {
                                 ...
                                 for (x = 1; x <= ulNumFiles; x++)
                                 {
                                    ...
                                    sprintf(szNewFileName,"%s\\%s.SMR%d",pszNewsGroup,szFileName, x);
                     ...
                     if (bLogs)
                        SaveLog("smr-usenet.LOG",pszHeader, ulHeaderLen, pszNewsGroup, strcmp(pszNewsGroup, szGroup));
