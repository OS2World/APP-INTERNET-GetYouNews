...
BOOL CheckForMultipart(PSZ pszHeader, ULONG ulHeaderLen, PSZ pszBody, ULONG ulBodyLen, PSZ pszNewsGroup, BOOL bLogs)
{
   ...
   pszUserAgent = SearchFor("X-Newsreader: Nomad News 2.00",pszHeader, ulHeaderLen, pszUserAgent);
...
/*                              printf("Saving Direct Read News filename %s part %d of %d\r\n",szFileName, ulPart, ulTotal);  */
                              sprintf(szNewFileName,"%s\\%s.Nomad%d",pszNewsGroup, szFileName, ulPart);
...
/*                              printf("Saving Direct Read News filename %s\r\n",szFileName);  */
                           ...
                           if (rc == 0)
                           {
                              ...
                              if (ulTotal > 1)
                              {
                                 ...
                                 sprintf(szFindFile,"%s\\%s.Nomad*",pszNewsGroup,szFileName);
                                 ...
                                 if (ulNumFiles == ulTotal)
                                 {
                                    ...
                                    if (rc == 0)
                                    {
                                       ...
                                       for (x = 1; x <= ulNumFiles; x++)
                                       {
                                          ...
                                          sprintf(szNewFileName,"%s\\%s.Nomad%d",pszNewsGroup,szFileName, x);
                           ...
                           if (bLogs)
                              SaveLog("NomadNews.LOG",pszHeader, ulHeaderLen, pszNewsGroup, strcmp(pszNewsGroup, szGroup));
